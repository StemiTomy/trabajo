...
public class SerieTest {
    ...
    public void testGetAll() {
        ...
        Capitulo capitulo1 = new Capitulo(0, "Cap 1", 60, "Primer cap", actores);
        ...
        Temporada temporada1 = new Temporada(0, fechaProduccion, fechaEstrenoMundial, capitulos, actores);
        ArrayList<Temporada> temporadas = new ArrayList<Temporada>();
        temporadas.add(temporada1);

        Serie serie = new Serie(1, "Breaking Bad", 2008, "Un profesor de química se convierte en fabricante de metanfetamina.", generosEsperados, temporadas, actores);
